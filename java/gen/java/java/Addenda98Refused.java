...
// Java class java.Addenda98Refused is a proxy for talking to a Go program.
//
...
public final class Addenda98Refused implements Seq.Proxy {
	static { Java.touch(); }
	...
	Addenda98Refused(int refnum) { this.refnum = refnum; Seq.trackGoRef(refnum, this); }
	
	public Addenda98Refused() { this.refnum = __New(); Seq.trackGoRef(refnum, this); }
	...
	public final native String getRefusedChangeCode();
	public final native void setRefusedChangeCode(String v);
	...
	public final native String getTraceSequenceNumber();
	public final native void setTraceSequenceNumber(String v);
	...
	@Override public boolean equals(Object o) {
		if (o == null || !(o instanceof Addenda98Refused)) {
		    return false;
		}
		Addenda98Refused that = (Addenda98Refused)o;
		String thisID = getID();
		...
		String thisRefusedChangeCode = getRefusedChangeCode();
		String thatRefusedChangeCode = that.getRefusedChangeCode();
		if (thisRefusedChangeCode == null) {
			if (thatRefusedChangeCode != null) {
			    return false;
			}
		} else if (!thisRefusedChangeCode.equals(thatRefusedChangeCode)) {
		    return false;
		}
		...
		String thisTraceSequenceNumber = getTraceSequenceNumber();
		String thatTraceSequenceNumber = that.getTraceSequenceNumber();
		if (thisTraceSequenceNumber == null) {
			if (thatTraceSequenceNumber != null) {
			    return false;
			}
		} else if (!thisTraceSequenceNumber.equals(thatTraceSequenceNumber)) {
		    return false;
		}
	...
	@Override public int hashCode() {
	    return java.util.Arrays.hashCode(new Object[] {getID(), getTypeCode(), getRefusedChangeCode(), getOriginalTrace(), getOriginalDFI(), getCorrectedData(), getChangeCode(), getTraceSequenceNumber(), getTraceNumber()});
	}
	
	@Override public String toString() {
		StringBuilder b = new StringBuilder();
		b.append("Addenda98Refused").append("{");
		b.append("ID:").append(getID()).append(",");
		b.append("TypeCode:").append(getTypeCode()).append(",");
		b.append("RefusedChangeCode:").append(getRefusedChangeCode()).append(",");
		...
		b.append("TraceSequenceNumber:").append(getTraceSequenceNumber()).append(",");
