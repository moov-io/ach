...
func TestAddendumer10__json(t *testing.T) {
	bs, err := json.Marshal(mockAddenda10())
	if err != nil {
		t.Fatal(err)
	}
...
func TestAddendumer12__json(t *testing.T) {
	bs, err := json.Marshal(mockAddenda12())
	if err != nil {
		t.Fatal(err)
	}
...
func TestAddendumer13__json(t *testing.T) {
	bs, err := json.Marshal(mockAddenda13())
	if err != nil {
		t.Fatal(err)
	}
...
func TestAddendumer14__json(t *testing.T) {
	bs, err := json.Marshal(mockAddenda14())
	if err != nil {
		t.Fatal(err)
	}
...
func TestAddendumer15__json(t *testing.T) {
	bs, err := json.Marshal(mockAddenda15())
	if err != nil {
		t.Fatal(err)
	}
...
func TestAddendumer16__json(t *testing.T) {
	bs, err := json.Marshal(mockAddenda16())
	if err != nil {
		t.Fatal(err)
	}
