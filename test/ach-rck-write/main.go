...
func main() {
	// Example transfer to write an ACH RCK file to debit a external institution's account
	...
	bh.CompanyEntryDescription = "REDEPCHECK"                            // will be on receiving account's statement
