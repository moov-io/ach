...
func main() {
	...
	fmt.Printf("Entry One Addenda: %v \n", achFile.Batches[0].GetEntries()[0].Addendum[0])
	eadOne := new(ach.Addenda05)
	EntryOneAddenda := achFile.Batches[0].GetEntries()[0].Addendum[0].String()
	...
	fmt.Printf("Entry Two Addenda: %v \n", achFile.Batches[0].GetEntries()[1].Addendum[0])
	eadTwo := new(ach.Addenda05)
	EntryTwoAddenda := achFile.Batches[0].GetEntries()[1].Addendum[0].String()
