...
func main() {
	// Example transfer to write an ACH POS file to send/credit a external institution's account
	...
	bh.CompanyEntryDescription = "Sale"                                  // will be on receiving account's statement
