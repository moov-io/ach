...
func main() {
	// Example transfer to write an ACH TRX file to send/credit a external institution's account
	...
	bh.CompanyEntryDescription = "ACH TRX"                               // will be on receiving account's statement
