...
func main() {
	// Example transfer to write an ACH XCK file to debit an external institution's account
	...
	bh.CompanyEntryDescription = "ACH XCK"                               // will be on receiving account's statement
