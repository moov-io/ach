...
func main() {
	// Example transfer to write an ACH CTX file to send/credit a external institution's account
	...
	bh.CompanyEntryDescription = "ACH CTX"                               // will be on receiving account's statement
