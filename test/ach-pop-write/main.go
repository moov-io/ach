...
func main() {
	// Example transfer to write an ACH POP file to debit a external institution's account
	...
	bh.CompanyEntryDescription = "ACH POP"                               // will be on receiving account's statement
