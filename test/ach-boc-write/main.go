...
func main() {
	// Example transfer to write an ACH BOC file to debit an external institution's account
	...
	bh.CompanyEntryDescription = "ACH BOC"                               // will be on receiving account's statement
