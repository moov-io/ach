...
func main() {
	// Example transfer to write an ACH CCD file with TXP addenda for tax payment
	...
	entry.IdentificationNumber = "TAXPAYER123*2023Q4*IRS*FEDERAL" // Tax payment information
	...
	addenda05.PaymentRelatedInformation = "TXP*123456789*FEDERAL*20231231*TAX2023Q4*500000*1*25000*2*5000*3**VER\\"
